...
const LOCAL_USERS = [
  ...
  { id: "local-reception", email: "reception@hocctest.local", name: "Receptionist", role: "BRANCH_USER", jobRole: "Reception User", allowedPages: ["dashboard", "appointments", "patients", "queue", "admissions", "billing", "checkout", "followups", "notifications", "globalSearch", "records", "tasks", "alerts"] },
